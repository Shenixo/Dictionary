        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          <Box
            sx={{
              ...
              alignItems: "center",
              gap: "10px",
              position: "relative",  // To stack both icons on top of each other
            }}
          >
            ...
            <motion.div
              ...
              style={{
                position: "absolute",  // Absolute positioning to stack on top of each other
                zIndex: onToggle ? 1 : 0,  // Switch z-index based on the toggle state
              }}
            >
            ...
            <motion.div
              ...
              style={{
                position: "absolute",  
                zIndex: onToggle ? 0 : 1,  // Switch z-index based on the toggle state
              }}
            >
