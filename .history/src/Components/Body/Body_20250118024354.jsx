      ...
      <Box sx={{ marginTop: "20px" }}>
        {result.meanings?.map((meaning, index) => (
          <Box key={index} sx={{ marginBottom: "20px" }}>
            ...
            <Typography sx={{marginBottom: "30px", fontFamily: "'Merriweather', serif", color: "#848484", fontWeight: "500"}} variant="p">Meaning:</Typography>
            {meaning.definitions.map((definition, defIndex) => (
              <Box key={defIndex} sx={{ marginBottom: "10px", marginTop: "30px" }}>
                <Typography
                  sx={{
                    fontSize: "1rem",
                    fontFamily: "'Merriweather', serif",
