      ...
      <Box sx={{ marginTop: "20px" }}>
        {result.meanings?.map((meaning, index) => (
          <Box key={index} sx={{ marginBottom: "20px" }}>
            <Box sx={{display: "flex", alignItems: "center", gap: "20px", margin: ""}}>
            <Typography
              sx={{
                fontSize: "1.2rem",
                fontWeight: "700",
            ...
            <Typography sx={{marginBottom: "2rem", display: "block", fontFamily: "'Merriweather', serif", color: "#848484", fontWeight: "500"}} variant="p">Meaning:</Typography>
