      ...
      <Box sx={{ marginTop: "20px" }}>
        {result.meanings?.map((meaning, index) => (
          <Box key={index} >
            ...
            <Typography sx={{marginBottom: "2rem", display: "block",, color: "#848484", fontWeight: "600", fontSize: "1rem"}} variant="p">Meaning:</Typography>
            {meaning.definitions.map((definition, defIndex) => ( fontFamily: "'Merriweather', serif"
